...
import com.playerstage.playerstage.models.ProductImagesExample.Criteria;
import com.playerstage.playerstage.models.ProductImagesExample.Criterion;
...
public class ProductImagesSqlProvider {
    ...
    public String countByExample(ProductImagesExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(ProductImagesExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("product_images");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(ProductImages record) {
        ...
        if (record.getIsCover() != null) {
            sql.VALUES("is_cover", "#{isCover,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ProductImages record = (ProductImages) parameter.get("record");
        ProductImagesExample example = (ProductImagesExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ProductImages record) {
        ...
        if (record.getIsCover() != null) {
            sql.SET("is_cover = #{isCover,jdbcType=TINYINT}");
        }
    ...
    protected void applyWhere(SQL sql, ProductImagesExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
