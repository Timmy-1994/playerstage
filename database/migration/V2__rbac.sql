...
BEGIN;
INSERT INTO `role` VALUES (UNHEX(REPLACE(UUID(),'-','')),'ROLE_SUPER', 1, NULL, NULL);
INSERT INTO `role` VALUES (UNHEX(REPLACE(UUID(),'-','')),'ROLE_ADMIN', 1, NULL, NULL);
INSERT INTO `role` VALUES (UNHEX(REPLACE(UUID(),'-','')),'ROLE_USER', 1, NULL, NULL);
COMMIT;
